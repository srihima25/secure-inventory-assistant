...
function App() {
  ...
  return <div className="app-shell">
    ...
    <main className="main-content">
      ...
      {screen === 'inventory' && <InventoryScreen products={filteredProducts} allProducts={products} search={search} setSearch={setSearch} onUpdate={updateStock} addProductId={addProductId} setAddProductId={setAddProductId} addQuantity={addQuantity} setAddQuantity={setAddQuantity} removeProductId={removeProductId} setRemoveProductId={setRemoveProductId} removeQuantity={removeQuantity} setRemoveQuantity={setRemoveQuantity} operationLoading={operationLoading} operationMessage={operationMessage} />}
