...
function VoiceScreen({ onInventoryUpdated }) { return <><div className="screen-intro"><span className="section-kicker">VOICE-FIRST WORKFLOW</span><h2>Talk to your inventory naturally.</h2><p>Choose a language, speak a command, then review the backend response.</p></div><VoiceAssistant onInventoryUpdated={onInventoryUpdated} /><div className="flow-steps"><span className="done">01 <b>Speak</b></span><span>02 <b>Process command</b></span><span>03 <b>Stock updated</b></span></div></> }
